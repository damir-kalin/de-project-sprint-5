...
class Loader:
    ...
    def __init__(self, table_name: str, collection_name: str, collection_loader: Reader, pg_dest: PgConnect, pg_saver: PgSaver, logger: Logger) -> None:
        ...
        self.WF_KEY = f"example_{table_name}_origin_to_stg_workflow"
    ...
    def run_copy(self) -> int:
        ...
        with self.pg_dest.connection() as conn:
            ...
            for d in load_queue:
                ...
                self.pg_saver.save_object(self.table_name, conn, str(d["_id"]), d["update_ts"], d)
